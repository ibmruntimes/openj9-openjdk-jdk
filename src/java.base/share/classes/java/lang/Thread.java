...
public class Thread implements Runnable {
    ...
    boolean getAndClearInterrupt() {
        ...
        /*
         * It is possible for the Java and native interrupted status to get out of sync. Sending
         * two interrupts to the same thread in quick succession can cause this. It is critical
         * that clearing the interrupted status also clears the native status. If the Java
         * interrupted status is false, it is important to verify that this is consistent with the
